...
df_estocastico = pd.read_csv(DATADIR / "estocastico00.csv")
...
plt.hist(x_deterministico, bins=50, color="red", alpha=0.6, label="Determinístico")

plt.hist(x_estocastico, bins=50, color="orange", alpha=0.6, label="Estocástico")
