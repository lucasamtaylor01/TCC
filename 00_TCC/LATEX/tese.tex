...
\banca{
  ...
  Prof. Dr. Clodoaldo Grotta Ragazzo -- IME-USP [sem ponto final],
...
Primeiramente, gostaria de agradecer ao professor Breno Raphaldini Ferreira da Silva pela ótima orientação, cativantes desafios e generosa confiança em todo processo. Além disso, gostaria de agradecer ao apoio do professor Honghu Liu por sua contribuição no desenvolvimento deste trabalho.
...
Quero também agradecer à minha mãe e meu pai por todo apoio incondicional durante este período tão importante, às amizades que o BMAC ofereceu pelo caminho, em especial Julio, Gustavo e Matheus, e aos demais amigos sempre presentes.
...
\input{00_TCC/01_LATEX/conteudo/capitulos/00_introducao}
\pagestyle{mainmatter}
...
\input{00_TCC/01_LATEX/conteudo/apendices/01_apendice_mori_zwanzig}
\input{00_TCC/01_LATEX/conteudo/apendices/02_apendice_lista_de_programas}
\input{00_TCC/01_LATEX/conteudo/apendices/03_apendice_simulacoes_computacionais}
\par
%%%% Anexos %%%%
