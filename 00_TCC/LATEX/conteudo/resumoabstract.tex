...
\palavraschave{Equações diferenciais estocásticas, Modelo de Lorenz 80, Sistemas dinâmicos rápidos-lentos}

\keywords{Stochastic differential equations, Lorenz 80 model, Fast-slow dynamical systems}
