...
\title{Uma abordagem estocástica para modelos rápidos-lentos}
\translatedtitle{A stochastic approach to fast-slow models}
...
\epigrafe{There are two ways to do great mathematics. The first is to be smarter than everybody else. The second way is to be stupider than everybody else -- but persistent.}{Raoul Bott}

Primeiramente, gostaria de agradecer ao professor Breno Raphaldini Ferreira da Silva pela ótima orientação, cativantes desafios e generosa confiança em todo processo. Além disso, gostaria de agradecer com o apoio do professor Honghu Liu por sua contribuição no desenvolvimento deste trabalho.

Estendo meu agradecimento a todos os professores da graduação que me proporcionaram uma nova forma de entender o mundo, da compreensão de fenômenos físicos à processos abstratos. Foi um privilégio estar presente nas aulas cativantes e ter contato com ideias tão belas e absolutamente maravilhosas.

Quero também agradecer à minha mãe e meu pai por todo apoio durante este período tão importante, às amizades que o BMAC ofereceu pelo caminho e aos amigos sempre presentes.

Por fim, é necessário voltar ao começo, professor Mauricio Osca Souza Pereira, ou ``Phalkon'', obrigado pelas histórias do IME foram elas que me trouxeram até aqui. 
...
\input{00_TCC/01_LATEX/conteudo/capitulos/00_exemplo_introducao}
\pagestyle{mainmatter}
\input{00_TCC/01_LATEX/conteudo/capitulos/01_lorenz_deterministico}
\input{00_TCC/01_LATEX/conteudo/capitulos/02_introducao_sde}
\input{00_TCC/01_LATEX/conteudo/capitulos/03_aproximacao_sistemas_deterministicos}
...
\input{00_TCC/01_LATEX/conteudo/apendices/01_apendice_consideracoes_matematicas}
\input{00_TCC/01_LATEX/conteudo/apendices/02_apendice_lista_de_programas}
\input{00_TCC/01_LATEX/conteudo/apendices/03_apendice_mori_zwanzig}
