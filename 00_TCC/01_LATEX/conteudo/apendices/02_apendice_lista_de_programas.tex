...
\section{Lorenz 80 determinístico}\label{app_sec:lorenz80-det}
...
\section{Simulação de mercado de ações}\label{app_sec:mercado-de-acoes}
...
\end{juliacode}
\section{Ruído caótico rápido}\label{app_sec:ruido-caotico-rapido}
