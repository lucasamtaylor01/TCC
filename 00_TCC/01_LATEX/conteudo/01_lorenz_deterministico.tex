...
\begin{itemize}
    ...
    \item \textbf{Condições de Hardley.}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{00_TCC/01_LATEX/figuras/ch01_lorenz_80/f01d01_cond_default.png}
    \caption{Simulação de 1 dia com $f_1=0.1$}
    \label{fig:f01d01_cond_default}
\end{figure}

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam posuere elit ut faucibus aliquet. In efficitur neque lectus, vel cursus nisl laoreet sed. Duis tempus ex tortor, consectetur vehicula ex suscipit id. Aliquam hendrerit, odio ut ullamcorper fringilla, purus tellus semper sapien, in aliquet tellus tellus in justo. Aliquam erat volutpat. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{00_TCC/01_LATEX/figuras/ch01_lorenz_80/f01d50_cond_default.png}
    \caption{Simulação de 50 dias com $f_1=0.1$}
    \label{fig:f01d50_cond_default}
\end{figure}

Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aenean dignissim mollis augue tristique ornare. Quisque vulputate sapien quis sapien sollicitudin, nec imperdiet lacus molestie. Vivamus et dui mauris. Sed feugiat augue vitae consequat viverra. Pellentesque volutpat luctus lobortis. Fusce ac pharetra velit. Suspendisse potenti. Etiam in orci non lorem eleifend varius. 
...
e o restante das variáveis iguais a zero. As simulações correspondem ao período de $400$ dias e, foi eliminado os $10\%$ dos dados iniciais, já que estes são uma fase que o sistema ainda está entrando no formado de atrator. Isto posto, conseguimos os seguintes resultados:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{00_TCC/01_LATEX/figuras/ch01_lorenz_80/l80_y3_x_y2.png}
    \caption{Simulação de 50 dias com $f_1=0.1$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{00_TCC/01_LATEX/figuras/ch01_lorenz_80/l80_y1_x_y2.png}
    \caption{Simulação de 50 dias com $f_1=0.1$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{00_TCC/01_LATEX/figuras/ch01_lorenz_80/l80_y1_x_y3.png}
    \caption{Simulação de 50 dias com $f_1=0.1$}
